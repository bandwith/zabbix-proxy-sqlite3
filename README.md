...
[![Build & Push](https://github.com/justprosound/zabbix-proxy-sqlite3/actions/workflows/ci-release.yml/badge.svg)](https://github.com/justprosound/zabbix-proxy-sqlite3/actions/workflows/ci-release.yml)
[![GitHub Release](https://img.shields.io/github/v/release/justprosound/zabbix-proxy-sqlite3)](https://github.com/justprosound/zabbix-proxy-sqlite3/releases)
...
docker run -d \
  ...
  ghcr.io/justprosound/zabbix-proxy-sqlite3:latest
```
...
services:
  zabbix-proxy:
    image: ghcr.io/justprosound/zabbix-proxy-sqlite3:latest
...
docker pull ghcr.io/justprosound/zabbix-proxy-sqlite3:latest

# Pull a specific version
docker pull ghcr.io/justprosound/zabbix-proxy-sqlite3:7.0.13
```
...
- 🐛 [Issue Tracker](https://github.com/justprosound/zabbix-proxy-sqlite3/issues)
- 💬 [Discussions](https://github.com/justprosound/zabbix-proxy-sqlite3/discussions)
...
[🌟 Star this repo](https://github.com/justprosound/zabbix-proxy-sqlite3) • [🐛 Report Bug](https://github.com/justprosound/zabbix-proxy-sqlite3/issues) • [💡 Request Feature](https://github.com/justprosound/zabbix-proxy-sqlite3/issues)
